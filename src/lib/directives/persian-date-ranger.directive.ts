...
@Directive({
  selector: '[persianDateRanger]',
})
export class PersianDateRangerDirective {
  private closeListener: (() => void) | null = null;

  @Input() dateFormat: DateFormat = "jYYYY/jMM/jDD";
  @Input() returnFormat: DateFormat = "jYYYY/jMM/jDD";
  ...
  private openCalendar(): void {
    ...
    const factory = this.resolver.resolveComponentFactory(PersianDateCalendarComponent);
  ...
  private updateCalendarByDate(dateStr: string): void {
    ...
    calendarInstance.selectYear(parsedDate.jYear());
    calendarInstance.selectMonth(parsedDate.jMonth());
    calendarInstance.selectedDay = parsedDate.jDate();
    calendarInstance.selectedMonth = parsedDate.jMonth();
    calendarInstance.selectedYear = parsedDate.jYear();
