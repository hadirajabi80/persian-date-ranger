...
const DATE_PICKER_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => PersianDateRangerComponent),
  multi: true,
};

@Component({
  selector: 'persian-date-ranger',
  templateUrl: './persian-date-ranger.component.html',
  styleUrls: ['./persian-date-ranger.component.scss'],
  providers: [DATE_PICKER_VALUE_ACCESSOR]
})
export class PersianDateRangerComponent
  extends PersianDateCalendarComponent
  ...
  getSelectedDate(value: string): void {
    ...
    const outputValue = this.returnFormat === 'timestamp'
      ...
      : moment(value, this.dateFormat === "timestamp" ? '' : this.dateFormat).format(this.returnFormat);
